 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'nothing
	...
	`(term-color-black ((,class (:foreground ,"#282828"))))
        `(term-color-blue ((,class (:foreground ,"#223d77"))))
        `(term-color-red ((,class (:foreground ,"#7b0f0f"))))
        `(term-color-green ((,class (:foreground ,"#254f17"))))
        `(term-color-yellow ((,class (:foreground ,"#615605"))))
        `(term-color-magenta ((,class (:foreground ,"#490f57"))))
        `(term-color-cyan ((,class (:foreground ,"#11576a"))))
